...
- [Native Dubbing media and URL ingest](issues/19-dubbing-native-media-ingest.md) - Native Dubbing now ingests local paths or optional managed URL downloads, selects caption artifacts deterministically, reuses Transcript ASR handoffs, checkpoints media-only sources, and never persists optional YouTube cookies.
